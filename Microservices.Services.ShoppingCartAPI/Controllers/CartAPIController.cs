...
using MicroservicesApp.Services.ShoppingCartAPI.Data;
    ...
    public class CartAPIController : ControllerBase
    {
        ...
        public async Task<ResponseDto> GetCart(string userId)
        {
            try
            {
                ...
                cart.CartDetails = _mapper.Map<IEnumerable<CartDetailsDto>>(_db.CartDetails.Where(u => u.CartHeaderId == cart.CartHeader.CardHeaderId));
        ...
        public async Task<ResponseDto> CartUpsert(CartDto cartDto)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        cartDto.CartDetails.First().CartHeaderId = cartHeaderFromDb.CardHeaderId;
                        _db.CartDetails.Add(_mapper.Map<CartDetails>(cartDto.CartDetails.First()));
                        await _db.SaveChangesAsync();
                    }
                    else
